   ...
   <center>
    ...
    <div align="center">
         <form action="insertUserReply" method="post">
			...
			<input type="radio" name="acceptOrDeny" value="accept" id="userAccept" checked>
    		<label for="userRole">Accept</label>
    
    		<input type="radio" name="acceptOrDeny" value="deny" id="userDeny">
    		<label for="rootRole">Deny</label>
    		<br>
			<label for="product">Reply</label>
            <input type="text" id="product" name="userReply"><br><br>
